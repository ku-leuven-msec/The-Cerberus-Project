...
print("generating MVEE_libcver.h...\n")
File.open("MVEE/Inc/MVEE_libcver.tmp", 'w') { |file|
  file.write("/* this file was generated by #{$PROGRAM_NAME} - do not edit manually */\n")
  file.write("#define LIBC_VER \"#{ARGV[0]}\"\n")
}

replace_if_different("#{@mveeroot}/MVEE/Inc/MVEE_libcver.h", "#{@mveeroot}/MVEE/Inc/MVEE_libcver.tmp")