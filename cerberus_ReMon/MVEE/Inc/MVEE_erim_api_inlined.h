...
// Starting value of PKRU register
#define DEFAULT_PKRU_VALUE (0x55555554)
...
/* partial wrpkru instructions macros */
#define RU 0xef
#define WRPK 0x010f
#define WR 0x0f
#define PKRU 0xef01

/* partial xrstor instructions macros */
#define XRST 0xae0f
#define XR 0x0f
#define ST 0xae

#define erim_isOR(ptr) \
   (((uint8ptr(ptr)[0] & 0xC0) != 0xC0 \
    && (uint8ptr(ptr)[0] & 0x38) == 0x28) ? 1 : 0)
